...
$hashFile = Join-Path $root "ShareWorkin_v1.05_SHA256.txt"
$zipFile = Join-Path $root "ShareWorkin_v1.05_Setup.zip"
$installer = Join-Path $root "ShareWorkin_v1.05_install.exe"
