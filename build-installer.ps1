...
$hashFile = Join-Path $root "ShareWorkin_v1.22_SHA256.txt"
$zipFile = Join-Path $root "ShareWorkin_v1.22_Setup.zip"
$installer = Join-Path $root "ShareWorkin_v1.22_install.exe"
