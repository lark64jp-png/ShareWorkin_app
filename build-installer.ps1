...
$hashFile = Join-Path $root "ShareWorkin_v1.15_SHA256.txt"
$zipFile = Join-Path $root "ShareWorkin_v1.15_Setup.zip"
$installer = Join-Path $root "ShareWorkin_v1.15_install.exe"
