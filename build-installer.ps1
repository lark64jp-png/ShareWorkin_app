...
$hashFile = Join-Path $root "ShareWorkin_v1.09_SHA256.txt"
$zipFile = Join-Path $root "ShareWorkin_v1.09_Setup.zip"
$installer = Join-Path $root "ShareWorkin_v1.09_install.exe"
