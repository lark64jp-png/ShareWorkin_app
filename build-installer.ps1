...
$hashFile = Join-Path $root "ShareWorkin_v1.06_SHA256.txt"
$zipFile = Join-Path $root "ShareWorkin_v1.06_Setup.zip"
$installer = Join-Path $root "ShareWorkin_v1.06_install.exe"
